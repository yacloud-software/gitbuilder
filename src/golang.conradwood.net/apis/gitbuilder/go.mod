...
require (
	...
	golang.conradwood.net/go-easyops v0.1.21929
...
require (
	...
	golang.conradwood.net/apis/auth v1.1.2643 // indirect
	...
	golang.conradwood.net/apis/goeasyops v1.1.2643 // indirect
	...
	golang.yacloud.eu/apis/session v1.1.2643 // indirect
