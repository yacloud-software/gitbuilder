...
require (
	...
	golang.conradwood.net/go-easyops v0.1.17944
...
require (
	...
	golang.conradwood.net/apis/autodeployer v1.1.2309 // indirect
	golang.conradwood.net/apis/deploymonkey v1.1.2309 // indirect
	...
	golang.conradwood.net/apis/registry v1.1.2309 // indirect
