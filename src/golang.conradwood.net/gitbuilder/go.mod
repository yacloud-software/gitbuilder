...
require (
	golang.conradwood.net/apis/auth v1.1.2105
	golang.conradwood.net/apis/common v1.1.2105
	golang.conradwood.net/apis/gitbuilder v0.0.0-00010101000000-000000000000
	golang.conradwood.net/apis/protorenderer v1.1.2105
...
require (
	...
	golang.conradwood.net/apis/autodeployer v1.1.2105 // indirect
	...
	golang.conradwood.net/apis/h2gproxy v1.1.2105 // indirect
	golang.conradwood.net/apis/objectstore v1.1.2105 // indirect
	golang.conradwood.net/apis/registry v1.1.2105 // indirect
	golang.conradwood.net/apis/rpcinterceptor v1.1.2105 // indirect
