...
require (
	...
	golang.conradwood.net/apis/autodeployer v1.1.2147 // indirect
	golang.conradwood.net/apis/deploymonkey v1.1.2147 // indirect
	...
	golang.conradwood.net/apis/registry v1.1.2147 // indirect
