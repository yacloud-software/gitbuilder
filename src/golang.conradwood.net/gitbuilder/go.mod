...
require (
	golang.conradwood.net/apis/auth v1.1.2644
	golang.conradwood.net/apis/common v1.1.2644
...
require (
	...
	golang.conradwood.net/apis/goeasyops v1.1.2644 // indirect
	...
	golang.yacloud.eu/apis/session v1.1.2644 // indirect
