...
require (
	golang.conradwood.net/apis/auth v1.1.2525
	...
	golang.conradwood.net/go-easyops v0.1.20213
...
require (
	...
	golang.conradwood.net/apis/echoservice v1.1.2525 // indirect
	golang.conradwood.net/apis/errorlogger v1.1.2525 // indirect
