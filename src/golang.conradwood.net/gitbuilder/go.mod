...
require (
	golang.conradwood.net/apis/auth v1.1.3060
	golang.conradwood.net/apis/common v1.1.3060
	...
	golang.conradwood.net/go-easyops v0.1.29397
...
require (
	...
	golang.conradwood.net/apis/goeasyops v1.1.3060 // indirect
	...
	golang.yacloud.eu/apis/session v1.1.3060 // indirect
